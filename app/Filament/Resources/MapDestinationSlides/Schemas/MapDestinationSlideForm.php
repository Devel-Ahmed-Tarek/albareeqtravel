...
namespace App\Filament\Resources\MapDestinationSlides\Schemas;
                ...
                Section::make('عام')
                    ->schema([
                        ...
                        FileUpload::make('image_path')
                            ->image()
                            ->disk('public')
                            ->directory('map-destination-slides')
                            ->visibility('public')
                ...
                Section::make('رابط البطاقة')
                    ->schema([
                        Select::make('link_route')
                            ...
                            ->searchable()
                            ->placeholder('— افتراضي: صفحة الوجهات —')
                            ->nullable()
                            ->label('رابط داخلي'),
                    ...
                    ->description('إن وُجد «رابط داخلي» يُستخدم. وإلا يُستعمل الرابط الخارجي لكل لغة. وإن لم تُضف: يُفتح صفحة الوجهات.'),
                Tabs::make('texts')
                    ->label('النصوص')
                    ->tabs([
                        Tab::make('ar')
