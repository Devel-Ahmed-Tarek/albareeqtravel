...
class MapDestinationSlide extends Model
{
    protected $fillable = [
        'sort_order',
        'is_active',
    ...
    public function resolvedUrl(): string
    {
        ...
        return localized_route('destinations');
    }
    ...
    {
        static::saving(function (MapDestinationSlide $m): void {
        ...
        static::deleting(function (MapDestinationSlide $m): void {
            if (filled($m->image_path)) {
