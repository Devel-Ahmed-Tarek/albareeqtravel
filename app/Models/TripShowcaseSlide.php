...
class TripShowcaseSlide extends Model
{
    protected $fillable = [
        'sort_order',
        'is_active',
    ...
    public function resolvedUrl(): string
    {
        ...
        return localized_route('programs');
    }
    ...
    {
        static::saving(function (TripShowcaseSlide $m): void {
        ...
        static::deleting(function (TripShowcaseSlide $m): void {
            if (filled($m->image_path)) {
